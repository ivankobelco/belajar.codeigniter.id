...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link rel="stylesheet" href="<?php echo base_url('/assets/vendor/bootstrap-4.5.0/css/bootstrap.css'); ?>">
  ...
  <a class="navbar-brand col-md-3 col-lg-2 mr-0 px-3" href="#">Belajar CI</a>
